...
def show_history():
    ...
    with open(history_file, 'r') as f:
        ...
        for items in history:
            files_listbox.insert(END, items['file_path'])
            links_listbox.insert(END, items['download_link'])
...
history_button = ttk.Button(window, text="Показать историю", command=show_history)
history_button.pack()
